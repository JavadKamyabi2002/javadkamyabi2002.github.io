...
function generateClockMarkings() {
  ...
  for (var i = 0; i < 360; i += 6) {
    markingContainer.innerHTML += `<div class="mark" style="transform: translate(-50%,-50%) rotate(${i}deg);opacity:${
      i % 30 == 0 ? 0.75 : 0.3
    };"></div>`;
  }
}
...
function switchTheme() {
  ...
  if (bodyElement === null) bodyElement = document.querySelector("body");
